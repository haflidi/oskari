Oskari.registerLocalization(
{
    ...
    "value": {
        ...
        "AnalyseView": {
            ...
            "content": {
                "label": "Kortalög",
                "drawToolsLabel": "Fitjutól",
                "tooltip": "Veldu eitt kortalag til greiningar. Þú getur leitað að fleiri kortalögum með því að smella á \"Bæta við kortalagi\" og velja kortalag úr listanum. Þú getur beint kortasýninni þinni að þeim stað sem þú vilt með því að draga kortið til með músinni eða með því að smella á \"Leita að stöðum\" og leita að þeim stöðum sem þú vilt.",
                "drawToolsTooltip": "Bættu við tímabundnum fitjum, klipptu fitjur sem eru til eða veldu fitjur með formi sem þú teiknar.",
                "features": {
                    ...
                    "tooltips": {
                        "point": "Bættu við tímabundnum punkti til að nota við greininguna.",
                        "line": "Bættu við tímabundinni línu til að nota við greininguna.",
                        "area": "Bættu við tímabundnu svæði til að nota við greininguna."
                    },
                    "modes": {
                        "area": "Tímabundið svæði",
                        "line": "Tímabundin lína",
                        "point": "Tímabundinn punktur"
                    }
                },
                "drawDialog": {
                    "point": {
                ...
                "search": {
                    "title": "Leita að stöðum",
                    "resultLink": "Nota í greiningu"
                }
            },
            "method": {
                "label": "Aðferð",
                "tooltip": "Veldu aðferð sem skal nota við greininguna. Þú getur lesið leiðbeiningar fyrir hverja aðferð með því að smella á i táknið hjá nafninu hennar.",
                "options": [
                    {
            ...
            "aggregate": {
                "label": "Lýsandi tölfræði",
                "labelTooltip": "Veldu þá lýsandi tölfræði sem skal reikna út frá eigindum fitjanna.",
                "options": [
                    {
